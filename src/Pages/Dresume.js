...
import styles from "./Dresume.module.css";
import { FaCalendar, FaGithub, FaLinkedin, FaMailBulk, FaMapPin, FaPaperclip, FaPhone } from "react-icons/fa";


const Dresume = forwardRef((props, ref) => {
          ...
          <div className={styles.links}>
            {info.basicInfo?.detail?.email ? (
              <a className={styles.link} type="email">
               <FaMailBulk/> {info.basicInfo?.detail?.email}
              </a>
            ) : (
              <span />
            )}
